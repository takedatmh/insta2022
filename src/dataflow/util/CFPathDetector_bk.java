 ...
 * @author s1930149
 */
public class CFPathDetector_bk {
...
//	private static String targetClass = "org.apache.catalina.manager.ManagerServlet";
	...
	private static Logger logger = LogUtil.createLogger(".\\Sample.log", CFPathDetector_bk.class);
	...
	public CFPathDetector_bk(String methodName, String mainClass, String targetClass){
	...
	public static void main(String[] args) {
		//In case that main argument is null, this application gets methodName, mainCalss and targetClass info from -D option argument values.
		if(args[0] == null){
			//TODO: Obtain soot main args from system properties.
				...
				.add(new Transform("wjtp.myTrans", new SceneTransformer() {
					protected void internalTransform(String phaseName,
						...
						List<List<Unit>> listOfPath = searchPathFromCFG(top, unitGraph, path, pathList);
								...
								/*20200506 Amend file path from ¥¥ to /. */
