...
//	public static String targetClass = "simple.logic.Logic_static";
	...
	private static String methodName = "list";
...
//	static String cgPath = ".\\CallGraph\\" + "CallGraph_"
//			+ targetClass+ "_" +methodName + DotGraph.DOT_EXTENSION;
//	static String CallGraphPathListPath = ".\\CallGraphPathList\\"+ targetClass + "_" + methodName + "_Simple" +".txt";
